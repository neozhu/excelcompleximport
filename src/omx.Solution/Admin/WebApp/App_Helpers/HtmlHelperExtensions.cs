...
namespace WebApp
{
  public static class HtmlHelperExtensions
  {
        ...
        string heading = "")
    {
      ...
      sb.AppendFormat("<div class=\"alert alert-{0} alert-dismissible fade show\">", alertType);
      sb.Append("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden = \"true\" ><i class=\"fal fa-times\"></i></span> </button>");
